...
public class QuartzDrop extends DropItem {
    ...
    @Override public Material getMaterial() { return Material.QUARTZ; }
    @Override public Material getSmeltedMaterial() { return Material.QUARTZ; }
    ...
    @Override public String getMessage() { return "§6+ §f§lKWARC"; }
