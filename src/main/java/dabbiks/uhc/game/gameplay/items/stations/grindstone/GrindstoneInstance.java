...
public class GrindstoneInstance {

    public final Location location;

    public TableInstance.Slot[] slots = new TableInstance.Slot[4];
    ...
    public void placeEnchantingTable() {
        slots[0] = new TableInstance.Slot(location.clone().add(0.1, 0.77, 0.1), 0, 90, 0.8f);
        slots[1] = new TableInstance.Slot(location.clone().add(0.9, 0.77, 0.1), 90, 90, 1.0f);
        slots[2] = new TableInstance.Slot(location.clone().add(0.1, 0.77, 0.9), 270, 90, 1.2f);
        slots[3] = new TableInstance.Slot(location.clone().add(0.9, 0.77, 0.9), 180, 90, 1.4f);
    ...
    public boolean fill() {
        ...
        for (TableInstance.Slot slot : slots) {
            if (!slot.filled) {
                fillSlot(slot);
                return true;
            }
    ...
    private void fillSlot(TableInstance.Slot slot) {
